...
async def get_drivers(
    ...
    return await list_drivers(db, onboarding_status=onboarding_status, skip=skip, limit=limit)
...
async def get_driver(
    ...
    return await get_driver_detail(db, driver_id)
...
async def approve(
    ...
    await approve_driver(db, driver_id, payload.franchise_id)
    return await get_driver_detail(db, driver_id)
...
async def reject(
    ...
    await reject_driver(db, driver_id, payload.rejection_reason)
    return await get_driver_detail(db, driver_id)
